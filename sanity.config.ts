...
const projectId = ((process.env as unknown) as Env).PUBLIC_SANITY_STUDIO_PROJECT_ID!;
const dataset = ((process.env as unknown) as Env).PUBLIC_SANITY_STUDIO_DATASET!;
const shopifyStoreDomain = ((process.env as unknown) as Env).PUBLIC_STORE_DOMAIN!;

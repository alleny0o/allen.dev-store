...
// Query: {  "announcementBar": coalesce(    announcementBar[_key == $language][0].value[],    announcementBar[_key == $defaultLanguage][0].value[],  )[] {    _type == "announcement" => {      _key,      externalLink,      link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},      openInNewTab,      text,    },  },  "utilityLinks": coalesce(    utilityLinks[_key == $language][0].value[],    utilityLinks[_key == $defaultLanguage][0].value[],  )[] {  _type == "externalLink" => {  _key,  _type,  link,  name,  openInNewTab,},  _type == "internalLink" => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},  _type == "megaMenu" => {  _key,  _type,  name,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  content[] {    _type == "linkSection" => {      _key,      _type,      heading,      headingLink -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},      links[] {        _type == "externalLink" => {  _key,  _type,  link,  name,  openInNewTab,},        _type == "internalLink" => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      }    },    _type == "imageBlock" => {      _key,      _type,      image,      alt,      heading,      description,      link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},      linkText,    }  }},},  announcementBarColorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  fadeTransition,  autoRotateAnnouncements,  announcementBarPadding,  showAnnouncementArrows,  announcementBarTextSize,  "menu": coalesce(    menu[_key == $language][0].value[],    menu[_key == $defaultLanguage][0].value[],  )[] {  _type == "externalLink" => {  _key,  _type,  link,  name,  openInNewTab,},  _type == "internalLink" => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},  _type == "megaMenu" => {  _key,  _type,  name,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  content[] {    _type == "linkSection" => {      _key,      _type,      heading,      headingLink -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},      links[] {        _type == "externalLink" => {  _key,  _type,  link,  name,  openInNewTab,},        _type == "internalLink" => {  _key,  _type,  anchor,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  name,},      }    },    _type == "imageBlock" => {      _key,      _type,      image,      alt,      heading,      description,      link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},      linkText,    }  }},},  menuItemGap,  menuItemPaddingX,  menuItemPaddingY,  colorScheme -> {  background {  alpha,  hex,  hsl,  rgb,},  border {  alpha,  hex,  hsl,  rgb,},  card {  alpha,  hex,  hsl,  rgb,},  cardForeground {  alpha,  hex,  hsl,  rgb,},  foreground {  alpha,  hex,  hsl,  rgb,},  primary {  alpha,  hex,  hsl,  rgb,},  primaryForeground {  alpha,  hex,  hsl,  rgb,},},  blur,  desktopLayout,  mobileLayout,  desktopLogoWidth,  showLocalizationSelector,  showWishlist,  accountStyleDesktop,  cartStyleDesktop,  cartStyleMobile,  headerMinHeight,  showSeparatorLine,  sticky}

...
// Query: {  _key,  _// Source: ./app/data/sanity/queries.ts
...
export type ROOT_QUERYResult = {
  ...
  header: {
    ...
    blur: boolean | null;
    desktopLayout: "centerLogo" | "classic" | "splitRight" | "threeColumn" | null;
  ...
  settings: {
    ...
    badgesPosition: "bottom_left" | "bottom_right" | "top_left" | "top_right" | null;
    badgesSaleColorScheme: {
      background: {
        alpha: null;
        hex: string | null;

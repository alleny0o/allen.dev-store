...
// Query: {  _key,  _type,  image,  alt,  heading,  description,  link -> {  'documentType': _type,  'slug': coalesce(    slug,    store.slug  ) {    _type,    current  },},  linkText,}

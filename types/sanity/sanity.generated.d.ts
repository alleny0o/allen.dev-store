...
export type Header = {
  ...
  layoutPreset?: "logo-left_nav-center_icons-right" | "logo-left_space-between_nav-icons-right" | "nav-left_logo-center_icons-right";
  colorScheme?: {
    _ref: string;
    _type: "reference";
    _weak?: boolean;
...
export type ImageBannerSection = {
  ...
  contentPosition?: "top_left" | "top_center" | "top_right" | "middle_left" | "middle_center" | "middle_right" | "bottom_left" | "bottom_center" | "bottom_right";
  contentAlignment?: "left" | "center" | "right";
  backgroundImage?: {
    asset?: {
      _ref: string;
...
export type AllSanitySchemaTypes = ProductSectionDesign | ThemeContent | Settings | Footer | Header | SocialLinksOnly | RichtextSection | RelatedProductsSection | ProductHeroSection | ImageBannerSection | FeaturedProductSection | FeaturedCollectionSection | CollectionProductGridSection | CollectionListSection | CollectionBannerSection | CarouselSection | ProductVariant | Typography | CollectionRule | ShopifyProductVariant | ProxyString | PriceRange | PlaceholderString | Option | Inventory | FontCategory | FontAsset | NestedNavigation | Link | InternalLink | Button | HeaderNavigation | ExternalLink | Anchor | ProductSections | CollectionSections | Sections | SectionSettings | ColorScheme | Richtext | RangeSlider | ProductRichtext | Padding | Footers | ContentPosition | ContentAlignment | ColorPicker | BannerRichtext | AspectRatios | AnnouncementBar | InternationalizedArrayBannerRichtextValue | InternationalizedArrayRichtextValue | InternationalizedArrayProductRichtextValue | InternationalizedArrayAnnouncementBarValue | InternationalizedArrayHeaderNavigationValue | InternationalizedArraySlugValue | InternationalizedArrayTextValue | InternationalizedArrayStringValue | InternationalizedArrayBannerRichtext | InternationalizedArrayRichtext | InternationalizedArrayProductRichtext | InternationalizedArrayAnnouncementBar | Home | Page | Product | ShopifyProduct | ProductTemplate | Collection | ShopifyCollection | CollectionTemplate | BlogPost | Seo | InternationalizedArrayHeaderNavigation | InternationalizedArraySlug | InternationalizedArrayText | InternationalizedArrayString | MediaTag | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type ROOT_QUERYResult = {
  ...
  settings: {
    ...
    noContainerMaxWidth: boolean | null;
  ...
  productSectionDesign: {
    ...
    mobileHeaderPaddingY: number | null;
    galleryDisplay: "carousel" | "grid" | "vertical" | null;
    gridGap: number | null;
    mediaBorderRadius: number | null;

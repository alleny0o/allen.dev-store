...
export type ROOT_QUERYResult = {
  ...
  header: {
    ...
    announcementBarTextSize: RangeSlider | null;
    menu: Array<
      | {
          _key: string;
          _type: 'externalLink';
